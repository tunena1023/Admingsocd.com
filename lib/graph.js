...
async function geocodeAddress(address, city, zip) {
  ...
  /* Intento 1: busqueda ESTRUCTURADA -- mucho mas confiable que un
     solo texto libre. Con texto libre ("1985 NW 94th St, Suite F,
     Clive, 50325, USA"), Nominatim a veces no sabe donde termina la
     calle y empieza la ciudad (la coma de "Suite F" lo confunde) --
     por eso direcciones con numero de suite/local fallaban seguido
     mientras otras sin eso pasaban bien. Con parametros separados
     (street/city/postalcode) no hay ambiguedad. */
...
module.exports = {
  ...
  TECHS_LIST, ORDER_ASSIGNMENTS_LIST, SERVICE_TIMES_LIST,
