/* ============================================================
   ...
   Con ?kind=completion o ?kind=request sirve esos documentos nuevos
   en su lugar (mismo mecanismo, distinto patron de archivo) -- sin
   kind, el comportamiento de siempre (el documento oficial).
