...
Token de GitHub: se pasa por bash_tool (comando git real en el sandbox), nunca
como texto plano sin uso. Ver WORKFLOW.md, sección "Cómo conectarse".
